...
describe("platformOf", () => {
	test.each([
		...
		["Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X) AppleWebKit/605.1.15 Mobile/15E148", "ios"],
		["Mozilla/5.0 (iPad; CPU OS 18_0 like Mac OS X) AppleWebKit/605.1.15 Mobile/15E148", "ios"],
		["Mozilla/5.0 (iPod touch; CPU iPhone OS 18_0 like Mac OS X) AppleWebKit/605.1.15", "ios"],
		["Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:141.0) Gecko/20100101 Firefox/141.0", "linux"],
		["Mozilla/5.0 (Linux; Android 15; Pixel 9) AppleWebKit/537.36 Chrome/140.0 Mobile Safari/537.36", "android"],
	...
	test("detects iPadOS desktop browsing from Mac identity and touch points", () => {
		expect(platformOf({ ...navigatorOf("Mozilla/5.0 (Macintosh; Intel Mac OS X)"), maxTouchPoints: 5 })).toBe("ios");
	});
